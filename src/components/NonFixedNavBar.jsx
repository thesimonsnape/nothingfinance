...
const NavBar = () => {
  return (
    <div className='h-16 md:h-20 w-[350px] md:w-[700px] lg:w-[1200px] rounded-full mt-10 flex justify-between items-center bg-transparent border border-[#363636] shadow-[#3838386a] shadow-md px-2 md:px-10 text-white z-10 backdrop-blur-sm'>
